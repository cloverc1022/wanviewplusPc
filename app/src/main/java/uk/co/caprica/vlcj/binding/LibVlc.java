...
public interface LibVlc extends Library {
    ...
    boolean libvlc_media_player_is_recordable(libvlc_media_player_t p_mi);

    boolean libvlc_media_player_is_recording(libvlc_media_player_t p_mi);

    int libvlc_media_player_record_stop(libvlc_media_player_t p_mi);

    int libvlc_media_player_record_start(libvlc_media_player_t p_mi, String psz_filepath);
